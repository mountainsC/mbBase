...
import com.cloud.core.adapter.FolderAdapter;
import com.cloud.core.adapter.ImageGridAdapter;
import com.cloud.core.beans.Folder;
import com.cloud.core.beans.ImageItem;
...
public class MultiImageSelectorFragment extends Fragment {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (index == 0) {
                            ...
                            if (null != folder) {
                                mImageAdapter.setData(folder.imageItems);
     ...
     */
    private void selectImageFromGrid(ImageItem image, int mode) {
        if (image != null) {
            if (mode == MODE_MULTI) {
                ...
                if (data.getCount() > 0) {
                    ...
                    do {
                        ...
                        if (!TextUtils.isEmpty(name)) {
                            image = new ImageItem(path, name, dateTime);
                            images.add(image);
                        }
                        if (!hasFolderGened) {
                            // get all folder data
                            ...
                            if (folderFile != null && folderFile.exists()) {
                                ...
                                if (f == null) {
                                    ...
                                    imageList.add(image);
                                    folder.imageItems = imageList;
                                    mResultFolder.add(folder);
                                } else {
                                    f.imageItems.add(image);
                                }
                            }
                        }
