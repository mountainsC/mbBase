...
public class DialogPlusBuilder {
    ...
    private int overlayBackgroundResource = android.R.color.transparent;
     ...
     */
    public DialogPlus create(String dialogId) {
        ...
        return new DialogPlus(this, dialogId);
    }
    ...
    public int[] getContentMargin() {
        int minimumMargin = context.getResources().getDimensionPixelSize(R.dimen.spacing_16);
