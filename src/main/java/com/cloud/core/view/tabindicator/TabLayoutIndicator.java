...
public class TabLayoutIndicator extends RelativeLayout {
    ...
    private OnTablayoutIndicatorItemClickListener onTablayoutIndicatorItemClickListener = null;

    public void setOnTablayoutIndicatorItemClickListener(OnTablayoutIndicatorItemClickListener listener) {
        this.onTablayoutIndicatorItemClickListener = listener;
    }
    ...
    private LinearLayout createTabItems(ViewPager viewPager,
        ...
        for (int i = 0; i < tabItems.size(); i++) {
            ...
            if (viewPager != null || contentFrameLayoutId != 0) {
                ...
                topTabs.setOnTabItemListener(new TopTabs.OnTabItemListener() {
                    @Override
                    public boolean onTabItemClick(int position) {
                        if (onTablayoutIndicatorItemClickListener != null) {

                            onTablayoutIndicatorItemClickListener.onTabItemClick(position);
                        }
                        return true;
                    }
                });
