    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                 ...
                 */
                if (dy > 0 && mContentView.getTranslationY() == -mContentViewTranslateY
                        && y >= PixelUtils.dip2px(getContext(),98)) {
                    if (!isScrollTop()) {
                        return false;
                    }
                }

                if (dy > 0 && mContentView.getTranslationY() == 0 && y >= PixelUtils.dip2px(getContext(),98)) {
                    return false;
                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContentView != null && mMonthView != null) {
            ...
            int h = height - mItemHeight
                    ...
                    PixelUtils.dip2px(getContext(),40))
                    - PixelUtils.dip2px(getContext(),1);
