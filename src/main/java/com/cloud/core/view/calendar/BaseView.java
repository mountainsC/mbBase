...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
        ...
        mOtherMonthTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
        ...
        mSchemeTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
        ...
        mSelectTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
        ...
        mCurDayTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
        ...
        mCurDayLunarTextPaint.setTextSize(PixelUtils.dip2px(context, TEXT_SIZE));
