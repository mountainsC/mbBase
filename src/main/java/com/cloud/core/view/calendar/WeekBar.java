...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("WeekBar".equalsIgnoreCase(getClass().getSimpleName())) {
            LayoutInflater.from(context).inflate(R.layout.cl_cv_week_bar, this, true);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mDelegate != null) {
            ...
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(PixelUtils.dip2px(getContext(), 40), MeasureSpec.EXACTLY);
        }
