...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.cl_cv_layout_calendar_view, this, true);
        ...
        params.setMargins(0, mDelegate.getWeekBarHeight() + PixelUtils.dip2px(context,1), 0, 0);
