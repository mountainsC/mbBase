...
class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_week_text_size, PixelUtils.dip2px(context, 12));
        mWeekBarHeight = (int) array.getDimension(R.styleable.CalendarView_week_bar_height, PixelUtils.dip2px(context, 40));
        ...
        mDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_day_text_size, PixelUtils.dip2px(context, 16));
        mLunarTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_lunar_text_size, PixelUtils.dip2px(context, 10));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height, PixelUtils.dip2px(context, 56));

        //年视图相关
        mYearViewMonthTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_text_size, PixelUtils.dip2px(context, 18));
        mYearViewDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_day_text_size, PixelUtils.dip2px(context, 8));
