...
public class CutCornerView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            topLeftCutSize = attributes.getDimensionPixelSize(R.styleable.CutCornerView_ccv_topLeftSize, topLeftCutSize);
            topRightCutSize = attributes.getDimensionPixelSize(R.styleable.CutCornerView_ccv_topRightSize, topRightCutSize);
            bottomLeftCutSize = attributes.getDimensionPixelSize(R.styleable.CutCornerView_ccv_bottomLeftSize, bottomLeftCutSize);
            bottomRightCutSize = attributes.getDimensionPixelSize(R.styleable.CutCornerView_ccv_bottomRightSize, bottomRightCutSize);
            attributes.recycle();
        }
