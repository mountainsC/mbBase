...
public class RoundRectView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            topLeftRadius = attributes.getDimensionPixelSize(R.styleable.RoundRectView_rrv_topLeftRadius, topLeftRadius);
            topRightRadius = attributes.getDimensionPixelSize(R.styleable.RoundRectView_rrv_topRightRadius, topRightRadius);
            bottomLeftRadius = attributes.getDimensionPixelSize(R.styleable.RoundRectView_rrv_bottomLeftRadius, bottomLeftRadius);
            bottomRightRadius = attributes.getDimensionPixelSize(R.styleable.RoundRectView_rrv_bottomRightRadius, bottomRightRadius);
            borderColor = attributes.getColor(R.styleable.RoundRectView_rrv_borderColor, borderColor);
            borderWidthPx = attributes.getDimensionPixelSize(R.styleable.RoundRectView_rrv_borderWidth, borderWidthPx);
            attributes.recycle();
        }
