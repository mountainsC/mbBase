...
public class BubbleView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            borderRadiusPx = attributes.getDimensionPixelSize(R.styleable.BubbleView_bv_bubble_borderRadius, dpToPx(10));
            position = attributes.getInteger(R.styleable.BubbleView_bv_bubble_arrowPosition, position);
            arrowHeightPx = attributes.getDimensionPixelSize(R.styleable.BubbleView_bv_bubble_arrowHeight, dpToPx(10));
            arrowWidthPx = attributes.getDimensionPixelSize(R.styleable.BubbleView_bv_bubble_arrowWidth, dpToPx(10));
            attributes.recycle();
        }
