...
public class DigitalKeyBoardAdapter extends BaseAdapter {
    ...
    public DigitalKeyBoardAdapter(Context context, List<String> datalist, DialogPlus dialogPlus, OnDigitalKeyBoardListener listener) {
    ...
    private class ItemViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TextUtils.equals(tag, "close")) {
                ...
                onDigitalKeyBoardListener.onKeyBoardListener(InputDigitalKeyType.digitalSymbol, tag, editText);
                if (editText != null) {
