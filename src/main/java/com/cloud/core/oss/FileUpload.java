...
class FileUpload {
    ...
    public void asyncResumableUpload(final Map<String, String> params) {
        try {
            ...
            DaoManager.getInstance().getBreakPointBeanDao(new Action1<BreakPointBeanDao>() {
                @Override
    ...
    public void appendUpload(final Map<String, String> params) {
        ...
        DaoManager.getInstance().getAppendPositionBeanDao(new Action1<AppendPositionBeanDao>() {
            @Override
