...
/**
 * Class that starts and stops item drags on a {@link BaseDragSortListView}
 ...
 * {@link BaseDragSortListView#setTouchListener()} and
 * {@link BaseDragSortListView#setFloatViewManager()} of your
 * {@link BaseDragSortListView} instance.
 */
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private BaseDragSortListView mDslv;
    private int mPositionX;

    /**
     * Calls {@link #DragSortController(BaseDragSortListView, int)} with a
     ...
     */
    public DragSortController(BaseDragSortListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public DragSortController(BaseDragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public DragSortController(BaseDragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
     ...
     */
    public DragSortController(BaseDragSortListView dslv, int dragHandleId, int dragInitMode,
    ...
    public boolean startDrag(int position, int deltaX, int deltaY) {
        ...
        if (mSortEnabled && !mIsRemoving) {
            dragFlags |= BaseDragSortListView.DRAG_POS_Y | BaseDragSortListView.DRAG_NEG_Y;
        }
        if (mRemoveEnabled && mIsRemoving) {
            dragFlags |= BaseDragSortListView.DRAG_POS_X;
            dragFlags |= BaseDragSortListView.DRAG_NEG_X;
        }
