 ...
 * this class implements the {@link BaseDragSortListView.DragSortListener}
 * interface, it is automatically set as the DragSortListener for
 * the DragSortListView instance.
 */
public abstract class DragSortCursorAdapter extends CursorAdapter implements BaseDragSortListView.DragSortListener {
     ...
     *
     * @see BaseDragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * and ListView positions. The Cursor is unchanged. Retrieve
     *
     * @see BaseDragSortListView.RemoveListener#remove(int)
     */
    @Override
