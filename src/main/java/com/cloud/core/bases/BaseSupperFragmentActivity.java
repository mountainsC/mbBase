...
import com.cloud.core.utils.InputMethodManagerUtils;
 ...
 * @ModifyContent:
 */
public class BaseSupperFragmentActivity extends FragmentActivity {

    /**
     * 当前分页索引
     */
    protected int currPageIndex = 1;
    protected UpdateFlow ubll = new UpdateFlow();
