...
public class RxCache {
    ...
    public static Object getObjectValue(String key) {
        if (redisCacheList.containsKey(key)) {
            return redisCacheList.get(key);
        }
        return null;
    }
     ...
     *                      return
     */
    private static CacheDataItem getBaseCacheData(Context context, String cacheKey, boolean isLimitations) {
        try {
     ...
     * @return
     */
    public static String getCacheData(Context context, String cacheKey, boolean isLimitations) {
        if (redisCacheList.containsKey(cacheKey)) {
            Object o = redisCacheList.get(cacheKey);
            if (o == null) {
                CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
                if (dataItem == null) {
                    return "";
                } else {
    ...
    public static String getCacheData(Context context, String cacheKey) {
        return getCacheData(context, cacheKey, false);
    }
     ...
     * @return
     */
    public static JSONObject getJsonObject(Context context, String cacheKey, boolean isLimitations) {
        try {
            CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static JSONObject getJsonObject(Context context, String cacheKey) {
        return getJsonObject(context, cacheKey, false);
    }
     ...
     * @return
     */
    public static JSONArray getJsonArray(Context context, String cacheKey, boolean isLimitations) {
        try {
            CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static JSONArray getJsonArray(Context context, String cacheKey) {
        return getJsonArray(context, cacheKey, false);
    }
     ...
     * @return
     */
    public static <T> T getCacheObject(Context context, String cacheKey, boolean isLimitations, Class<T> dataClass) {
        CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static <T> T getCacheObject(Context context, String cacheKey, Class<T> dataClass) {
        return getCacheObject(context, cacheKey, false, dataClass);
    }
     ...
     * @return
     */
    public static <T> List<T> getCacheList(Context context, String cacheKey, boolean isLimitations, Class<T> dataClass) {
        CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static <T> List<T> getCacheList(Context context, String cacheKey, Class<T> dataClass) {
        return getCacheList(context, cacheKey, false, dataClass);
    }
     ...
     * @return
     */
    public static boolean getCacheFlag(Context context, String cacheKey, boolean isLimitations, boolean defaultValue) {
        if (redisCacheList.containsKey(cacheKey)) {
            Object o = redisCacheList.get(cacheKey);
            if (o == null) {
                CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static boolean getCacheFlag(Context context, String cacheKey, boolean defaultValue) {
        return getCacheFlag(context, cacheKey, false, defaultValue);
    }
     ...
     * @return
     */
    public static int getCacheInt(Context context, String cacheKey, boolean isLimitations) {
        if (redisCacheList.containsKey(cacheKey)) {
            Object o = redisCacheList.get(cacheKey);
            if (o == null) {
                CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static int getCacheInt(Context context, String cacheKey) {
        return getCacheInt(context, cacheKey, false);
    }
     ...
     * @return
     */
    public static long getCacheLong(Context context, String cacheKey, boolean isLimitations) {
        if (redisCacheList.containsKey(cacheKey)) {
            Object o = redisCacheList.get(cacheKey);
            if (o == null) {
                CacheDataItem dataItem = getBaseCacheData(context, cacheKey, isLimitations);
    ...
    public static long getCacheLong(Context context, String cacheKey) {
        return getCacheLong(context, cacheKey, false);
    }
}
