...
public class AppInfoUtils {
    ...
    public static <T extends Application> Object getMetaObject(T application, String metaKey) {
        try {
    ...
    public static <T extends Application> boolean getMetaBoolean(T application, String metaKey) {
        try {
