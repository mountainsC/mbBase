...
import com.cloud.core.beans.PeriodOfTime;
...
import com.cloud.core.events.Func5;
...
public class DateUtils {
    ...
    public static String getDisplayPeriodTime(long timeStamp, DisplayPeriodTimeType displayPeriodTimeType) {
        try {
            Func5<String, DisplayPeriodTimeType, Integer, Integer, Calendar, Integer> hourPeriodFunc = new Func5<String, DisplayPeriodTimeType, Integer, Integer, Calendar, Integer>() {
                @Override
                public String call(DisplayPeriodTimeType displayPeriodTimeType, Integer curryear, Integer currmonth, Calendar currdate, Integer minutes) {
                    //在一小时内
            ...
            Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar> twoHourFunc = new Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar>() {
                @Override
                public String call(DisplayPeriodTimeType displayPeriodTimeType, Integer curryear, Integer currmonth, Calendar currdate) {
                    //在两小时内
                    if (displayPeriodTimeType == DisplayPeriodTimeType.MMDDHHMM) {
                        SimpleDateFormat sdf = new SimpleDateFormat(DateFormatEnum.MMDDHHMM.getValue());
                        return sdf.format(currdate.getTime());
            ...
            Func5<String, DisplayPeriodTimeType, Integer, Integer, Calendar, Integer> dayFunc = new Func5<String, DisplayPeriodTimeType, Integer, Integer, Calendar, Integer>() {
                @Override
                public String call(DisplayPeriodTimeType displayPeriodTimeType, Integer curryear, Integer currmonth, Calendar currdate, Integer minutes) {
                    //在一天内
                    if (displayPeriodTimeType == DisplayPeriodTimeType.MMDDHHMM) {
            ...
            Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar> twoDayFunc = new Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar>() {
                @Override
                public String call(DisplayPeriodTimeType displayPeriodTimeType, Integer curryear, Integer currmonth, Calendar currdate) {
                    //在2天内
                    if (displayPeriodTimeType == DisplayPeriodTimeType.MMDDHHMM) {
            ...
            Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar> greaterTwoDayFunc = new Func4<String, DisplayPeriodTimeType, Integer, Integer, Calendar>() {
                @Override
                public String call(DisplayPeriodTimeType displayPeriodTimeType, Integer curryear, Integer currmonth, Calendar currdate) {
                    if (displayPeriodTimeType == DisplayPeriodTimeType.MMDDHHMM) {
                        SimpleDateFormat sdf = new SimpleDateFormat(DateFormatEnum.MMDDHHMM.getValue());
            ...
            if (timediff > 0) {
                ...
                if (minutes < 60) {
                    return hourPeriodFunc.call(displayPeriodTimeType, curryear, currmonth, currdate, minutes);
                } else if (minutes < 120) {
                    return twoHourFunc.call(displayPeriodTimeType, curryear, currmonth, currdate);
                } else if (minutes < 60 * 24) {
                    return dayFunc.call(displayPeriodTimeType, curryear, currmonth, currdate, minutes);
                } else if (minutes < 60 * 24 * 2) {
                    return twoDayFunc.call(displayPeriodTimeType, curryear, currmonth, currdate);
                } else {
                    return greaterTwoDayFunc.call(displayPeriodTimeType, curryear, currmonth, currdate);
                }
            } else {
                if (displayPeriodTimeType == DisplayPeriodTimeType.MMDDHHMM) {
                    SimpleDateFormat sdf = new SimpleDateFormat(DateFormatEnum.HHmm.getValue());
