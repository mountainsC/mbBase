...
public class RoundProgressView extends View {
    ...
    private void initView() {
        ...
        mRadius = PixelUtils.dip2px(getContext(), 20);
        mOutsideCircle = PixelUtils.dip2px(getContext(), 7);
        mPath.setStrokeWidth(PixelUtils.dip2px(getContext(), 3));
        mPantR.setStrokeWidth(PixelUtils.dip2px(getContext(), 3));
