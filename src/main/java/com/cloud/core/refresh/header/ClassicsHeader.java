package com.cloud.core.refresh.header;
...
import com.cloud.core.refresh.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        LayoutParams lpArrow = new LayoutParams(PixelUtils.dip2px(context, 20), PixelUtils.dip2px(context, 20));
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextTimeMarginTop, PixelUtils.dip2px(context, 0));
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, PixelUtils.dip2px(context, 20));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, PixelUtils.dip2px(context, 16)));
        } else {
            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, PixelUtils.dip2px(context, 12)));
        } else {
        ...
        if (getPaddingTop() == 0) {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = PixelUtils.dip2px(context, 20), getPaddingRight(), mPaddingBottom = PixelUtils.dip2px(context, 20));
            } else {
                setPadding(getPaddingLeft(), mPaddingTop = PixelUtils.dip2px(context, 20), getPaddingRight(), mPaddingBottom = getPaddingBottom());
            }
        } else {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = getPaddingTop(), getPaddingRight(), mPaddingBottom = PixelUtils.dip2px(context, 20));
            } else {
...
//                replaceRefreshLayoutBackground(refreshLayout);
    ...
    public ClassicsHeader setTextTimeMarginTop(float dp) {
        return setTextTimeMarginTopPx(PixelUtils.dip2px(getContext(), dp));
    }
    ...
    public ClassicsHeader setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(PixelUtils.dip2px(getContext(), dp));
    }
    ...
    public ClassicsHeader setDrawableSize(float dp) {
        return setDrawableSizePx(PixelUtils.dip2px(getContext(), dp));
    }
    ...
    public ClassicsHeader setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(PixelUtils.dip2px(getContext(), dp));
    }
    ...
    public ClassicsHeader setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(PixelUtils.dip2px(getContext(), dp));
    }
