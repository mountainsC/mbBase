...
public class CusLinearLayout extends LinearLayout {
    private int[] R_styleable_LinearLayout = new int[]{
            /* 0 */ android.R.attr.divider,
            /* 1 */ android.R.attr.measureWithLargestChild,
            /* 2 */ android.R.attr.showDividers,
            /* 3 */ android.R.attr.dividerPadding,
    };
    private int LinearLayout_divider = 0;
    private int LinearLayout_measureWithLargestChild = 1;
    private int LinearLayout_showDividers = 2;
    private int LinearLayout_dividerPadding = 3;
