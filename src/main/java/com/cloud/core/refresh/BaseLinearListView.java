 ...
 */
public class BaseLinearListView extends CusLinearLayout {
    ...
    public BaseLinearListView(Context context) {
        this(context, null);
    }

    public BaseLinearListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseLinearListView parent, View view, int position, long id);
    }
    ...
    private class InternalOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            if ((mOnItemClickListener != null) && (mAdapter != null)) {
                mOnItemClickListener.onItemClick(BaseLinearListView.this, v,
