...
abstract class PictureSelectEditorView extends LinearLayout implements OnLinearDragerListener {
    ...
    private void init(boolean flag, AttributeSet attrs) {
        if (flag) {
            ...
            addBackgoundResource = a.getResourceId(R.styleable.PictureSelectEditorView_iev_addBackgoundResource, R.drawable.add_image_bg);
    ...
    private void requestPermission(Action1 action) {
