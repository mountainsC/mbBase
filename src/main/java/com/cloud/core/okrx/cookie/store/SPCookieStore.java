package com.cloud.core.okrx.cookie.store;

import android.content.Context;
import android.content.SharedPreferences;
import android.text.TextUtils;

import com.cloud.core.okrx.cookie.SerializableCookie;
...
public class SPCookieStore implements CookieStore {
    private String COOKIE_PREFS = "okrx_cookie";           //cookie使用prefs保存
    private String COOKIE_NAME_PREFIX = "cookie_";         //cookie持久化的统一前缀
