...
public class EasyPermissions {
    ...
    public static void requestPermissions(
            Activity host, String rationale,
            int requestCode, @Size(min = 1) String... perms) {
        requestPermissions(
     ...
     */
    public static void requestPermissions(
            Fragment host, String rationale,
            int requestCode, @Size(min = 1) String... perms) {
        requestPermissions(
                new PermissionRequest.Builder(host, requestCode, perms)
                        .setRationale(rationale)
     ...
     */
    public static void requestPermissions(
            android.app.Fragment host, String rationale,
            int requestCode, @Size(min = 1) String... perms) {
        requestPermissions(
                new PermissionRequest.Builder(host, requestCode, perms)
                        .setRationale(rationale)
     ...
     */
    public static boolean somePermissionPermanentlyDenied(Activity host,
     ...
     */
    public static boolean somePermissionPermanentlyDenied(Fragment host,
                                                          List<String> deniedPermissions) {
        return PermissionHelper.newInstance(host)
                .somePermissionPermanentlyDenied(deniedPermissions);
    }
     ...
     * @see #somePermissionPermanentlyDenied(Activity, List).
     */
    public static boolean somePermissionPermanentlyDenied(android.app.Fragment host,
                                                          List<String> deniedPermissions) {
        return PermissionHelper.newInstance(host)
                .somePermissionPermanentlyDenied(deniedPermissions);
    }
     ...
     */
    public static boolean permissionPermanentlyDenied(Activity host,
     ...
     */
    public static boolean permissionPermanentlyDenied(Fragment host,
                                                      String deniedPermission) {
        return PermissionHelper.newInstance(host).permissionPermanentlyDenied(deniedPermission);
    }
     ...
     * @see #permissionPermanentlyDenied(Activity, String).
     */
    public static boolean permissionPermanentlyDenied(android.app.Fragment host,
                                                      String deniedPermission) {
        return PermissionHelper.newInstance(host).permissionPermanentlyDenied(deniedPermission);
    }
     ...
     */
    public static boolean somePermissionDenied(Activity host,
                                               String... perms) {
     ...
     */
    public static boolean somePermissionDenied(Fragment host,
                                               String... perms) {
        return PermissionHelper.newInstance(host).somePermissionDenied(perms);
    }
     ...
     * @see #somePermissionDenied(Activity, String...)
     */
    public static boolean somePermissionDenied(android.app.Fragment host,
                                               String... perms) {
        return PermissionHelper.newInstance(host).somePermissionDenied(perms);
    }
