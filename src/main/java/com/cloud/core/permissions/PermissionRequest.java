...
public final class PermissionRequest {
    ...
    public static final class Builder {
        ...
        public PermissionRequest build() {
            if (mRationale == null) {
                mRationale = "如果没有请求的权限，此功能将无法正常工作.";
            }
            if (mPositiveButtonText == null) {
                mPositiveButtonText = mHelper.getContext().getString(R.string.confirm_text);
            }
            if (mNegativeButtonText == null) {
                mNegativeButtonText = mHelper.getContext().getString(R.string.cancel_text);
            }
