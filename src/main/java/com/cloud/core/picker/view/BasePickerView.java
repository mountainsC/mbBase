...
import com.cloud.core.picker.listener.OnDismissListener;
import com.cloud.core.picker.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.pickerview_layout_basepickerview, null, false);
            //设置界面的背景为透明
