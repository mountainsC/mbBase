package com.cloud.core.hvlayout;
 ...
 * @Description:https://github.com/jeasonlzy/HeaderViewPager
 * @Modifier:
 * @ModifyContent:
 */
public class HeaderTabsViewLayout extends LinearLayout {
    ...
    public HeaderTabsViewLayout(Context context) {
        this(context, null);
    }

    public HeaderTabsViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeaderTabsViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HeaderTabsViewLayout);
        topOffset = (int) a.getDimension(R.styleable.HeaderTabsViewLayout_htvp_topOffset, topOffset);
        a.recycle();
