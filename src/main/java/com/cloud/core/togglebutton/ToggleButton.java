package com.cloud.core.togglebutton;
...
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        isDefaultOn = typedArray.getBoolean(R.styleable.ToggleButton_tbIsDefaultOn, isDefaultOn);
        typedArray.recycle();
    ...
    public void toggle(boolean animate) {
        ...
        if (listener != null) {
            listener.onToggle(toggleOn, this.getTag());
        }
    }
    ...
    public interface OnToggleChanged {
         ...
         * @param extras
         */
        public void onToggle(boolean on, Object... extras);
    }
