package com.cloud.core.magicindicator.buildins.commonnavigator;
...
import com.cloud.core.magicindicator.NavigatorHelper;
import com.cloud.core.magicindicator.ScrollState;
import com.cloud.core.magicindicator.abs.IPagerNavigator;
import com.cloud.core.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.cloud.core.magicindicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.cloud.core.magicindicator.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.magic_pager_navigator_layout_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.magic_pager_navigator_layout, this);
        }
